...
From the calculated distances, the distance histogram of RR Lyrae stars is plotted and shown in FIG. \ref{fig:dhist}. The spatial distributions of RR Lyrae stars are shown in  FIG. \ref{fig:RRspace}.
